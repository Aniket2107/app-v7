...
<p><span class="style6"><strong>Current Location: </strong></span><?php echo $row['country'];?>, <?php echo $row['city'];?> | <strong>Notice Period:</strong> </span> <?php echo $row['noticeperiod'];?> | <strong>Last Modified Date:</strong> </span> <?php echo date("j F, Y",strtotime($row['lastmodified']));  ?></p>
