...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     <title>ROW Franchise Payment | Recruiters Hub</title>
...
<div class="account-navi-content">
  <div class="tab-content">
	...
	<div class="panel panel-default">
      <header class="panel-heading wht-bg ui-sortable-handle">
        <h3 class="text-center"><b>PAY TO BECOME OUR FRANCHISE IN THE REST OF THE WORLD (ROW) </b></h3>
      </header>
  ...
  <p class="pricing-title">ROW Franchise Fee</p>
   <p class="pricing-rate">Equivalent to £ 10,000   <span>One Off</span> <span class="exclides-vat">+ VAT OUT OF SCOPE IF PAYING FROM OUTSIDE THE UK</span> </p>
...
<!--   <li><form><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_NsDqZhAWo4ixxf" async> </script> </form></li>-->

<a class="subs-button" href="https://pay.gocardless.com/BRT00032TCET5YV" target="_blank"> Pay Now </a>
 ...
 <div class="pricing-list ">
    <ul>
<li><i class="fa fa-filter"></i>We will generate leads from within your territoty and an average 5-7 new clients sign up per month</li>
<li><i class="fa fa-arrows"></i>Through our marketing efforts we will sign up new clients in your territory <br>and help you acquire new clients from outside your territory using your unique Employer Sign Up link</li>
 <li><i class="fa fa-dollar"></i>An average earning potential of equivalent to $7000/resource in your team per month </li>
 ...
 <li><i class="fa fa-users"></i>Over 4000 Recruitment Vendors to support delivery of candidates</li>
  ...
  <li><i class="fa fa-rocket"></i>ROI: Your full investment return in 2 months based on just 3 placements given an average Placement fee as $5000 per permanent placement. </li>
...
<!-- <a class="subs-button" href="https://pay.gocardless.com/BRT00032SMXYADS" target="_blank"> Pay Now </a> -->
      ...
      <li><i class="fa fa-dollar"></i><a href="https://www.recruitinghub.com/bankdetails" target="_blank">Use Pay Now button above or Click here to pay into our bank account directly </a></li>
    </ul>
  </div>
</div>
