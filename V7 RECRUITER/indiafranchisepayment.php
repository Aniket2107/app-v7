...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     <title>India Franchise Payment | Recruiters Hub</title>
...
<div class="account-navi-content">
  <div class="tab-content">
	...
	<div class="panel panel-default">
      <header class="panel-heading wht-bg ui-sortable-handle">
        <h3 class="text-center"><b>PAY TO BECOME OUR FRANCHISE IN INDIA </b></h3>
      </header>
  ...
  <p class="pricing-title">Tier 1 City Franchise</p>
   <p class="pricing-rate"> Rs.5,00,000   <span>One Off</span> <span class="exclides-vat">+ 18% GST </span> </p>
  <p class="description">TIER 1 CITY</p>
...
<form><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_NsDdXxWJiuObUT" async> </script> </form>
...
<input type="hidden" name="plan" value="Basic"  />
 ...
 <div class="pricing-list ">
    <ul>
 <li><i class="fa fa-filter"></i>Tier1 Cities generates more leads usually 15-20 new clients sign up per month</li>
 <li><i class="fa fa-arrows"></i>Through our marketing efforts we will sign up new clients in your territory and help you acquire new clients from outside your territory using your unique Employer Sign Up link</li>
 <li><i class="fa fa-inr"></i>An average earning potential of Rs.5 lakhs/resource in your team per month </li>
 
 <li><i class="fa fa-users"></i>Over 4000 Recruitment Vendors to support delivery of candidates</li>
 
 <li><i class="fa fa-link"></i>Take full advantage of our software automation in the external recruitment industry </li>
 
  <li><i class="fa fa-support"></i>We provide full IT,Admin,Sales,Marketing,Client Payment Collection support</li>
  
  <li><i class="fa fa-rocket"></i>ROI: Your full investment return in 3 months based on just 12 placements given an average Indian Placement fee as Rs.50k per permanent placement. </li>

     <li><form><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_NsDdXxWJiuObUT" async> </script> </form></li> 
   
  <!--  <li><i class="fa fa-money"><a href="https://www.recruitinghub.com/Franchise%20Brochure%20-%20RecruitingHub.pdf" target="_blank">Download our Franchise Brochure</a></li> -->
   
      <li><i class="fa fa-inr"></i><a href="https://www.recruitinghub.com/bankdetails" target="_blank">Use Pay Now button above or Click here to pay into our bank account directly </a></li>
    </ul>
  </div>
</div>
<div class="col-md-4 col-sm-12 col-xs-12">
  <div class="pricing-header ">
  <p class="pricing-title">Tier 2 City Franchise</p>
  <p class="pricing-rate"> Rs.3,00,000 <span>One Off</span> <span class="exclides-vat">+ 18% GST </span> </p>
  <p class="description">TIER 2 CITY</p>
  <!--<div class="terms-of-business">by clicking this button I agree to the <a class="title" href="#" data-toggle="modal" data-target="#employer-terms">Terms of Service </a> </div> <br> <br>-->
    <form><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_NsDegfJdmlhqIw" async> </script> </form>
...
<input type="hidden" name="plan" value="Advanced"  />
 ...
 <div class="pricing-list ">
    <ul>
<li><i class="fa fa-filter"></i>Tier2 Cities generates little less than Tier1 leads usually 7-15 new clients sign up per month</li>
<li><i class="fa fa-arrows"></i>Through our marketing efforts we will sign up new clients in your territory and help you acquire new clients from outside your territory using your unique Employer Sign Up link</li>
 <li><i class="fa fa-inr"></i>An average earning potential of Rs.3 lakhs/resource in your team per month </li>
 <li><i class="fa fa-users"></i>Over 4000 Recruitment Vendors to support delivery of candidates</li>
 ...
 <li><i class="fa fa-link"></i>Take full advantage of our software automation in the external recruitment industry </li>
  ...
  <li><i class="fa fa-rocket"></i>ROI: Your full investment return in 3 months based on just 7 placements given an average Indian Placement fee as Rs.50k per permanent placement. </li>
 
     <li> <form><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_NsDegfJdmlhqIw" async> </script> </form></li>
...
<div class="col-md-4 col-sm-12 col-xs-12">
  <div class="pricing-header ">
  <p class="pricing-title">Tier 3 City Franchise</p>
  <p class="pricing-rate"> Rs.2,00,000 <span>One Off</span> <span class="exclides-vat">+ 18% GST </span> </p>
  <p class="description">TIER 3 CITY</p>
  <!--<div class="terms-of-business">by clicking this button I agree to the <a class="title" href="#" data-toggle="modal" data-target="#employer-terms">Terms of Service </a> </div> <br> <br>-->
    <form><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_NsDfgnI9fEBefn" async> </script> </form>
...
<input type="hidden" name="plan" value="Advanced"  />
 ...
 <div class="pricing-list ">
    <ul>
<li><i class="fa fa-filter"></i>Tier3 Cities generates far less than Tier1&2 leads usually 1-2 new clients sign up per month</li>
<li><i class="fa fa-arrows"></i>Through our marketing efforts we will sign up new clients in your territory and help you acquire new clients from outside your territory using your unique Employer Sign Up link</li>
 <li><i class="fa fa-inr"></i>An average earning potential of Rs.1 lakh/resource in your team per month </li>
 <li><i class="fa fa-users"></i>Over 4000 Recruitment Vendors to support delivery of candidates</li>
 ...
 <li><i class="fa fa-link"></i>Take full advantage of our software automation in the external recruitment industry </li>
  ...
  <li><i class="fa fa-rocket"></i>ROI: Your full investment return in 3 months based on just 5 placements given an average Indian Placement fee as Rs.50k per permanent placement. </li>
 
    <li> <form><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_NsDfgnI9fEBefn" async> </script> </form></li>
