...
$jobres = mysqli_query($link,"SELECT a.*,b.website,b.accountmanager,companyprofile.profile as companydescription,b.replacementperiod,b.specialnotes FROM jobs a,employers b,companyprofile,members WHERE a.jobid='$jobid' and a.memberid=members.memberid and members.companyid=companyprofile.id and companyprofile.registerid=b.id"); 
