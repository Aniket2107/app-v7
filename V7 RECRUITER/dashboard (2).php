...
<ul class="navbar-right">
  ...
  <img src="images/user.png" class="img-circle" alt="">     <span class="text"><?php echo $name; ?></span><span class="caret"></span> </a>
    <ul class="dropdown-menu" role="menu"><li><a href="company-profile"><i class="fa fa-user"></i>Agency Profile</a>   </li>
      ...
      <li><a href="manage-users"><i class="fa fa-gears"></i>Manage Users</a></li>
        <?php if($admin){
...
$parray1=array('5','6','7','8','8.33','10','12','12.5','15','20','25');
  ...
  <td>
   ...
   if(($checkpriority!='0')){echo' <span class="label label-primary">Priority</span>'; } echo'
  	...
  	echo '</small> | <small>'.$row['joblocation'].'</small>,<small>'.$row['country'].'</small> | <small>'.$row['jobtype'].'</small></td>
...
<div class="panel panel-default widget-mini" id="account_statistic">
  ...
  <div class="panel-body">
    <div class="col-sm-4">
  <span class="total text-center"><b><?php echo $live; ?></b></span>
  <small><span class="title text-center"><a class="dashboard_view_all" title="View All" href="job"><b>Live engagements</b></a></span></small>
</div>
<div class="col-sm-4">
  <small><span class="total text-center"><b><?php echo $total; ?></b></span></small>
  <small><span class="title text-center">Total engagements</span></small>
</div>
<div class="col-sm-4">
  <span class="total text-center"><b><?php echo $filled; ?></b></span>
  <small><span class="title text-center"><a class="dashboard_view_all" title="View All" href="filled"><b>Candidates Placed</b></a></span></small>
</div>
