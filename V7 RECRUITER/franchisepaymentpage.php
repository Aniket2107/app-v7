...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     <title>Franchise Payment Page | Recruiters Hub</title>
...
<div class="account-navi-content">
  <div class="tab-content">
	...
	<div class="panel panel-default">
      <header class="panel-heading wht-bg ui-sortable-handle">
        <h3 class="text-center"><b>CHOOSE THE COUNTRY WE HAVE AVAILABLE FRANCHISES IN </b></h3>
      </header>
  ...
  <p class="pricing-title">£ UK Franchise</p>
   

<a class="subs-button" href="ukfranchisepayment" target="_blank">Choose UK Franchise </a>
...
<div class="col-md-4 col-sm-12 col-xs-12">
  <div class="pricing-header ">
  <p class="pricing-title">₹ India Franchise</p>
  
  <a class="subs-button" href="indiafranchisepayment" target="_blank">Choose India Franchise </a>
...
<div class="col-md-4 col-sm-12 col-xs-12">
  <div class="pricing-header ">
  <p class="pricing-title">$ Rest of World (ROW)</p>
 
<a class="subs-button" href="rowfranchisepayment" target="_blank">Choose ROW Franchise </a>
<input type="hidden" name="plan" value="Advanced"  />
