		...
		<table style="border-right:1px solid #d5d8d9;border-left:1px solid #d5d8d9;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#000" align="center" bgcolor="#792785" border="0" cellpadding="0" cellspacing="0" width="620">
		  <tbody><tr>
			<td style="padding:12px 12px 0px 12px"><table style="border-right:1px solid #d5d8d9;border-left:1px solid #d5d8d9" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="100%">
			  <tbody>
			  <tr><td colspan="3" style="padding-left:14px"><div style="boder:0"><a href="https://www.recruitinghub.com/recruiter/login"><img src="https://www.recruitinghub.com/image/color-logo.png" alt="www.recruitinghub.com"></a></div></td>
					  </tr>
			  <tr>
						...
						<td valign="top"><table border="0" cellpadding="0" cellspacing="0" width="100%">
						  ...
						  <tr>
							<td style="padding:4px 0 0 0;line-height:16px;color:#313131">Best Regards,<br>
							  <a href="https://www.recruitinghub.com/recruiter/login" style="color:#313131" target="_blank">www.recruitinghub.com </a><br>
							  <br>
		 ...
		 <tr>
			...
			//	mail($to, $subject, $message, $headers);
						...
						$params = ['from'=>'noreply@recruitinghub.com','name'=>'Recruiting Hub','to'=>$to,'cc'=>$fetchemail['email'],'cc2'=>'noreply@recruitinghub.com','subject'=>$subject,'message'=>$message,'send'=>true];
                AsyncMail($params);
