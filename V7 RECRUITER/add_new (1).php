...
<div class="account-navi-content">
  ...
  <div class="row">
    ...
    </span> | <a href="https://recruitinghub.com/Candidate Submissions.pdf" target="_blank">
...
<div class="col-sm-10">
<input class="form-control" required  placeholder="e.g Alex Manning" name="fname" type="text">
...
<div class="col-sm-10">
<input class="form-control" required  placeholder="e.g alex.manning@gmail.com" name="email" type="email">
