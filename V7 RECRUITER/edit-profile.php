...
if(isset($_POST['submit'])){
	...
	mysqli_query($link,"update members set email='".$_POST['email']."',firstname='".$_POST['fname']."',lastname='".$_POST['lname']."',location='".$_POST['location']."',mobile='".$_POST['mobile']."',designation='".$_POST['jobtitle']."',linkedin='".$_POST['linkedin']."',biography='".htmlspecialchars($_POST['additionalinfo'],ENT_QUOTES)."' where memberid='".$_POST['memberid']."'");
	
	$content="<p style = 'font-size: 16px;
            color: #21a021;
        '>Your personal profile is successfully updated. Click here to go to Agency Profile -> <a href=https://www.recruitinghub.com/recruiter/company-profile><b>Agency Profile</b></a></p>";
}
...
<div class="col-sm-10">
<input class="form-control" required value="<?php echo $profile['location']; ?>" name="location" type="text">
</div></div>
