...
if (is_uploaded_file($_FILES["invoice"]["tmp_name"]) ) {
	...
	$namerow1=mysqli_fetch_assoc($namesql1);
			...
			$fetchcandid2=mysqli_fetch_assoc(mysqli_query($link,"select id from candidates where id='$candidateid'"));
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tbody>
                   ...
                   Dear '.$fname.',
                     ...
                     <p> Your CV that was submitted by <strong>'.$fetchempname['name'].'</strong> to the Client <strong>'.$fetchempnamename['name'].'</strong> for the position <strong>'.$fetchjobtitle['jobtitle'].'</strong> has been UPDATED <br><br>
                     
                            Your Candidate Id is - <strong>'.$id.'</strong> which you may use as reference to communicate with us or the agency that submitted your profile. <br>
                            <br>
