...
if(isset($_GET['candidateid']) || isset($_POST['allcheck'])){
	...
	$q2=mysqli_query($link,"select e.email,e.duplicatenotification,d.name,e.firstname from companyprofile d,members e ,submitted_candidates c where  d.id=e.companyid  and e.memberid=c.recruiterid and c.candidateid='$candidateid'");
