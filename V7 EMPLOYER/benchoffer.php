...
$candidatemsg="<p style='
            font-size: 14px;
            color: #a02121;
        '>No offered candidates yet. Please check Filled folder. Or <a href='add_new'><b>Submit New Candidate</b></a></p>";
?>
<!doctype html>
<html>
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     <title>Bench Offer | Employers Hub</title>
...
<div class="table-responsive">
 ...
 <form method="get" action="offer">
  ...
  <td><b><a class="title" href="#" data-toggle="modal" data-target="#candidate-modal" id='.$row['id'].'>'.$row['fname'].'</a></b><br>';	
  	...
  	echo ' | '.$row['candidateid'].'</small> | '.$row['jobtype'].' <br> <small>Employer Notes: '.$row['employernotes'].'</small> <br> <small>Recruiter Notes: '.$row['recruiternotes'].'</small> <br> <small>AM Notes: '.$row['amnotes'].'</small> <br> <small>'.$row['comment'].'</small></td>
