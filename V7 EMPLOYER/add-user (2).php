...
if(isset($_POST['submit'])){
	...
	mysqli_query($link,"insert into members(email,companyid,iam,firstname,lastname,mobile,location,emailactivated,designation,linkedin,biography,admin,active,adminrights,accountmanager,password,signupdate) values('".$_POST['email']."','$companyid','$iam','".$_POST['fname']."','".$_POST['lname']."','".$_POST['mobile']."','".$_POST['location']."','1','".$_POST['jobtitle']."','".$_POST['linkedin']."','".$_POST['additionalinfo']."','$admin',1,'$adminrights','$email','hub123',now())");
...
$content="<p style = 'font-size: 16px;
            color: #21a021;
        '>New user <b>".$_POST['fname']."</b> has been activated. Please ask this user to check their email inbox including spam folder for login details. Your email id would also have received a copy of the login credentials, please check your email.  Click here to go to Manager Users section -> <a href=https://www.recruitinghub.com/employer/manage-users><b>Manage Users</b></a></p>";
		...
		<table style="border-right:1px solid #d5d8d9;border-left:1px solid #d5d8d9;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#000" align="center" bgcolor="#792785" border="0" cellpadding="0" cellspacing="0" width="620">
		  <tbody><tr>
			<td style="padding:12px 12px 0px 12px"><table style="border-right:1px solid #d5d8d9;border-left:1px solid #d5d8d9" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="100%">
			  <tbody>
			  <tr><td colspan="3" style="padding-left:14px"><div style="boder:0"><a href="https://www.recruitinghub.com/employer/login"><img src="https://www.recruitinghub.com/image/color-logo.png" alt="www.recruitinghub.com"></a></div></td>
					  </tr>
			  <tr>
						...
						<td valign="top"><table border="0" cellpadding="0" cellspacing="0" width="100%">
						  ...
						  <tr>
							<td style="padding:4px 0 0 0;line-height:16px;color:#313131">Thanks and Regards,<br>
							  <a href="https://www.recruitinghub.com/employer/login" style="color:#313131" target="_blank">www.recruitinghub.com </a><br>
							  <br>
...
'subject'=>$subject,'message'=>$message,'cc'=>$fetchemail['email'],'cc2'=>$r['email'],'cc3'=>'employers@recruitinghub.com','cc4'=>'noreply@recruitinghub.com','send'=>true];
	AsyncMail($params);
	}
}
...
<div class="col-sm-10">
<input class="form-control" placeholder="location" required name="location" type="text">
</div></div>
