...
//var_dump($cnsd);
    ...
    <td  colspan="2" style="padding:12px 12px 0px 12px">
      <table style="border-right:1px solid #d5d8d9;border-left:1px solid #d5d8d9" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>  
              ...
              <td colspan="3" style="padding-right:12px"><div style="boder:0"><a href="https://www.recruitinghub.com/recruiter/login"><img src="https://www.recruitinghub.com/image/Message.png" alt="www.recruitinghub.com"></a></div></td>
          </tr>
        <tr>
 ...
 <tr>
  ...
  move_uploaded_file($_FILES['attach']['tmp_name'], "../pm/".$attachidz."/".$attach);
              ...
              $params = ['from'=>'noreply@recruitinghub.com','name'=>'Recruiting Hub','to'=>$empsemail,'subject'=>$dn1['subject'],'message'=>$message_temlt,'cc'=>$r['email'],'cc2'=>'noreply@recruitinghub.com','send'=>true];
