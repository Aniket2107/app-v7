...
$status='Open';
$content='Sorry could not refresh your job';
if(isset($_GET['jobid'])){
	$jobid=$_GET['jobid'];
...
$content='You have successfully made your job active';
		...
		$subject = "RecruitingHub.com - Thank you for resubmitting your vacancy";
		$message = '<html>
		<body bgcolor="#FFFFFF">
		<div>
                ...
                <td valign="top"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                  ...
                  <tr>
                    <td style="padding-top:5px;color:#313131"><br>
                      Dear ' . $name . ',<br>
                      <br>
                      Thank you for resubmitting your vacancy with us. Our AI Mechanism will now trigger this job to the best recruitment agencies from within our network and you will shortly receive engagement request from agencies<br>
					                </td>                
                </tr>            
                                    <tr>
                    <td>&nbsp;</td>
