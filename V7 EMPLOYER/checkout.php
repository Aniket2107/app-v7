...
<head>
    ...
    <title>India Subscription Plans | Employers Hub</title>
...
<h3 class="panel-title"> India Checkout </h3>
</header>
...
<input type="hidden" name="redirect_url" value="https://www.recruitinghub.com/employer/ccavResponseHandler"/>
<input type="hidden" name="cancel_url" value="https://www.recruitinghub.com/employer/ccavResponseHandler"/>
...
<div class="col-sm-10">
<input class="form-control" name="amount" type="text" value="Rs.<?php echo $tamount ?>" readonly >
<small><p>(Net Amount + 18% GST)</p></small>
</div></div>
...
<div class="col-sm-10">
<input class="form-control" name="merchant_param2" value="<?php echo $mnth; ?> Month" readonly />
</div></div>
