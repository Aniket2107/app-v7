...
require_once 'insert-bench-job.php';
}
...
<div class="account-navi-content">
  ...
  <div class="row">
    ...
    <h3 class="panel-title"> Post a Bench Job to our IT Vendors (Hire 2X Faster) - Just takes a minute </h3>
  </header>
        <div class="panel-body">
<?php if(!$content) {?>
<form method="post" action="post-benchjob.php" enctype="multipart/form-data" id="jobpost">
...
<option value="">Select No of Agencies Limit (Number of Agencies Allowed to Engage on this Role)</option>
<?php for($l=5;$l<=100;$l+=5){
	echo '<option value="'.$l.'">'.$l.'</option>';
}
?></select>
</div></div>
...
<?php for($c=10000;$c<=100000;$c+=5000){ ?>
...
console.log($('[name="country"]').val())
	if(jobtype[0]==="Bench" && ['Europe','US','UK','India','Middle East'].includes($('[name="country"]').val())){
		console.log($('[name="country"]').val())
		$("#rfee").hide();
	}else{
		$("#rfee").show();
...
$('#country').on('change',function(){
	...
	if($('[name="jobtype"]').val()==="Bench" && ['Europe','US','UK','India','Middle East'].includes($('[name="country"]').val())){
	//	console.log($('[name="country"]').val())
		$("#rfee").hide();
	}else{
		$("#rfee").show();
...
//	console.log($('[name="country"]').val())
 ...
 var rfee=document.getElementsByName("rfee")[0].value;
	...
	else if((((minex==="0") && (maxex==="2")) ||((minex==="0") && (maxex==="1"))||((minex==="1") && (maxex==="2"))) && (scountry==="India")&&(jtype==="Bench")){
...
$('#country').on('change',function(){
	...
	var scountry=document.getElementsByName("country")[0].value;
	 ...
	 if( ($(this).val()==="Bench" && (scountry=="UK"))){
	...
	else if( ($(this).val()==="Bench" && (scountry=="US"))){
		...
		$('#oc').append("<option value='HUF'>HUF (Hungarian Forints)</option>");
		}
	else if( ($(this).val()==="Bench" && (scountry=="Europe"))){
	...
	else if( ($(this).val()==="Bench" && (scountry=="Middle East"))){
	...
	else if( ($(this).val()==="Bench" && (scountry=="Africa"))){
	...
	else if( ($(this).val()==="Bench" && (scountry=="Australia"))){
	...
	else if( ($(this).val()==="Bench" && (scountry=="Canada"))){
	...
	else if( ($(this).val()==="Bench" && (scountry=="Singapore"))){
	...
	else if( ($(this).val()==="Bench" && (scountry=="Malaysia"))){
	...
	else if( ($(this).val()==="Bench" && (scountry=="Indonesia"))){
	...
	else if( ($(this).val()==="Bench" && (scountry=="Russia"))){
	...
	else if( ($(this).val()==="Bench" && (scountry=="Japan"))){
	...
	else if( ($(this).val()==="Bench" && (scountry=="China"))){
	...
	else if( ($(this).val()==="Bench" && (scountry=="Hong Kong"))){
	...
	else if( ($(this).val()==="Bench" && (scountry=="Vietnam"))){
	...
	else if( ($(this).val()==="Bench" && (scountry=="Philippines"))){
	...
	else if( ($(this).val()==="Bench" && (scountry=="Mexico"))){
	...
	else if( ($(this).val()==="Bench" && (scountry=="South America"))){
		...
		else if( ($(this).val()==="Bench" && (scountry=="North Korea"))){
		...
		else if( ($(this).val()==="Bench" && (scountry=="South Korea"))){
	...
	else if( ($(this).val()==="Bench") && (scountry=="India")){
