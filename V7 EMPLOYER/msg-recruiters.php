...
$empres=mysqli_query($link,"SELECT * FROM jobs a,companyprofile b ,request c, members d WHERE c.employerid='$mid' and c.jobid=a.jobid and c.recruiterid=d.memberid and b.id=d.companyid");
...
$job =  mysqli_fetch_array($empres);



 $subjectPost =  "RecruitingHub.com - Message from -" .$empcnsd['name'];



  //  $job =  mysqli_fetch_array($empres)

  foreach(explode(",",$_POST['rids']) as $rec){
  ...
  $dirCopy = "";
    ...
    $subject = test_input($subjectPost);
...
//replace image invalid names
    ...
    <td  colspan="2" style="padding:12px 12px 0px 12px">
      ...
      <table style="border-right:1px solid #d5d8d9;border-left:1px solid #d5d8d9" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>  
              ...
              <td colspan="3" style="padding-right:12px"><div style="boder:0"><a href="https://www.recruitinghub.com/recruiter/login"><img src="https://www.recruitinghub.com/image/High Priority.png" alt="www.recruitinghub.com"></a></div></td>
        ...
        <td style="padding:0px 14px"><table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <tbody><tr>
            ...
            Please login to your Account and click MESSAGING to reply back to this message. Login here <a href="https://www.recruitinghub.com/recruiter/login" target="_blank"><b>Recruiter Login</b></a></p>
                            ...
                            <p>You have received a message from <strong>'.$empcnsd["name"].'</strong> as below</p>
 ...
 <tr>
  ...
  $dirCopy = "../pm/".$attachid."/".$attach;

  }else if($_FILES["attach"]["tmp_name"] && !$dirCopy == ""  ){

    copy( $dirCopy,"../pm/".$attachid."/".$attach);
  ...
  $params = ['from'=>'noreply@recruitinghub.com','name'=>'Recruiting Hub','to'=>$empsemail,'subject'=>$subject,'message'=>$message_temlt,'cc'=>$r['email'],'cc2'=>'noreply@recruitinghub.com','send'=>true];
  ...
  <a href="#candidatesDropdownMenu1" data-toggle="collapse" aria-controls="candidatesDropdownMenu1" title="Candidates" class="navbar-root your-candidates">
   ...
   <ul class="nav-sub" style="display: block;">
    ...
    <li><?php 
	   ...
	   <li><a href="rec-rec-india"><i class="fa fa-money"></i> Hire a Recruiter <span class="label label-primary">New</span></a></li>';}

	   else{echo'

	    <li><a href="rec-rec"><i class="fa fa-money"></i> Hire a Recruiter <span class="label label-primary">New</span></a></li>';
      ...
      <div class="pageheader pageheader--buttons">
          ...
          <div class="row">
                 ...
                 <div class="col-md-12">
                  ...
                  <a class="btn btn-primary" href="rating">
...
<div class="tab-content">   
 ...
 <div class="col-xs-12">
      ...
      <form enctype="multipart/form-data" action="msg-recruiters" method="post">
        ...
        <div class="form-group col-sm-12">
                ...
                <div class="col-sm-9">
                  ...
                  <input type="hidden" name="rids" value="<?php echo $_GET['rids']; ?>" />
