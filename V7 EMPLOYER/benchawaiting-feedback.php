...
$candidatemsg="<p style='
            font-size: 14px;
            color: #a02121;
        '>No pending feedbacks. Submit Candidates to Engaged Jobs. <a href='add_new'><b>Submit New Candidate</b></a></p>";
?>
<!doctype html>
<html>
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     <title>Bench Awaiting Feedback | Employers Hub</title>
...
<div class="account-navi-content">
  ...
  <div class="row">
    ...
    <h3 class="panel-title"> Awaiting feedback </h3> <!--<span class="label label-primary">Agencies have 6 months ownership over submitted candidates if not duplicated by Client - Keep in good contact with your candidates</span>
...
<div class="table-responsive">
   <?php if(!$candidatemsg){ ?>
   <div class="col-sm-12">
 <form method="get" action="benchawaiting-feedback">
 ...
 <p style = 'font-size: 14px;
            color: #a02121;'>No feedback yet? Click Open the CV and click "<b>ADD NOTES</b>" to follow up with Client (Please be polite to clients when chasing for feedback) </p>
</div>
    ...
    </span> <span class="badge badge-default">'.$row['jobstatus'].'</span> <br> <small>Employer Notes: '.$row['employernotes'].'</small> <br> <small>Vendor Notes: '.$row['recruiternotes'].'</small> <br> <small>AM Notes: '.$row['amnotes'].'</small> <br> <small>'.$row['comment'].'</small></td>
  
  <td> <a class="title" href="/employer/benchawaiting-feedback?jobtitle='.urlencode($row['jobtitle']).'&candidate=&employer=&status=&submit=Search" >'.$row['jobtitle'].'</a><br><b>'.$row['name'].'</b> / <small>'.$row['jobid'].'</small> </td>';
