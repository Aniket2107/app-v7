...
$request='';
$request=array();
 $res=mysqli_query($link,"SELECT a.requestid,a.status,b.firstname as name,c.name as companyname,a.recruiterid FROM request a,members b, companyprofile c WHERE jobid='$jobid' and b.memberid=a.recruiterid and b.companyid=c.id");
