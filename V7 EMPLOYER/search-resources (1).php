...
$keywordres="and ((a.jobtitle like '%$keyword%')||(a.consultant like '%$keyword%')||(a.cv1 like '%$keyword%')||(a.skills like '%$keyword%'))";
...
<b><a href="resources">Upload More Bench Resources</a></b> ||

<b><a href="view-all-resource-engagement">Approve Request's</a></b> ||
<b><a href="view-resources">View Your Bench Resources</a> </b></section>
</header>  
...
<h4 class="gen-case"><b>Search our Database of Bench Resources Uploaded by other Employers</b> </h4>
...
<option value="South America">South America</option>
				...
				$cnt=mysqli_num_rows($sql1);
                    ...
                    <td><b><a class="title" href="#" data-toggle="modal" data-target="#candidate-modal" id='.$row['id'].'>'.$row['consultant']. ' </a></b> <br><small>';	
