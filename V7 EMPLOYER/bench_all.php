...
$candidatemsg="<p style='
            font-size: 14px;
            color: #a02121;
        '>No Resources submitted by you yet! <a href='add_new'><b>Submit New Resource</b></a></p>";
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     <title>All Submitted Bench Resources | Employers Hub</title>
...
<a href="https://recruitinghub.com/Candidate Submissions.pdf" target="_blank">
    <i class="fa fa"></i> <b>Check if you Submitted Resources Properly?</b>
</a> |


<a href="https://recruitinghub.com/recruiter/bestpractices-recruiter"target="_blank">
    <i class="fa fa"></i> <b>Best Practices</b>
</a> |

<a href="https://recruitinghub.com/Upload Additional File.pdf" target="_blank">
    <i class="fa fa"></i> <b>Amend Candidate Details / Add Additional Files</b>
</a> <br><br>
  ...
  <div class="panel-body">
        <div class="text-left">
 Go to -> <a href="add_new" id="one">ADD NEW CANDIDATE</a> -> <a href="bench_all" id="two"><strong><i class="fa fa-list"></i> ALL</strong></a> -> <a href="benchawaiting-feedback" id="three"><i class="fa fa-clock-o"></i> AWAITING FEEDBACK</a> -> <a href="benchinterview" id="four"><i class="fa fa-user"></i> SHORTLISTED</a> -> <a href="benchoffer" id="five"><i class="fa fa-download"></i> OFFERED</a> -> <a href="benchrejected" id="six"><i class="fa fa-trash"></i> REJECTED</a> -> <a href="benchfilled" id="seven"><i class="fa fa-money"></i> FILLED</a> ||  <a class="btn btn-primary" href="all-download<?php if($param)
 echo'?'.$param; ?>">
...
<p style = 'font-size: 14px;
            color: #a02121;'> No feedback yet? Click Open the Profile and click "<b>ADD NOTES</b>" to follow up with Client (Please be polite to clients when chasing for feedback) </p>
</div>
	...
	if($row['prestatus']=='Awaiting Feedback')
  	 ...
  	 {echo date("j F, Y",strtotime($row['addeddate']));}
  	echo ' | '.$row['id'].'</small> | '.$row['jobtype'].' <br><small>Candidate Status:</small> <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="STATUS OF CANDIDATE SUBMITTED BY YOU"><i class="fa fa-question-circle"></i>
  ...
  if($row['jobtitle'])
   echo '<td><a class="title" href="/employer/bench_all?jobtitle='.urlencode($row['jobtitle']).'&candidate=&employer=&status=&submit=Search">'.$row['jobtitle'].'</a> / <small>'.$row['jobid'].'</small><br><b>'.$row['employer'].'</b> </td>';
  else
