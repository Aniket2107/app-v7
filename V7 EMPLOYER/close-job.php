...
if(isset($_GET['jobid'])){
	...
	mysqli_query($link,"update jobs set status='Closed' WHERE jobid='$jobid' and memberid='$mid'"); 
	
	$content="You have closed the job";
	
	//mail to agency
	$to = "noreply@recruitinghub.com";

			$from = "noreply@recruitinghub.com";

            $r=	getAccountManagerDetail($link,$mid);

			$subject = "RecruitingHub.com - Client Closed the Job";
                                      ...
                                      <tr>
                                        <td><p>
                                         Dear '.$array2['firstname'].',<br>
                                          ...
                                          <br>
                                          Closed the Job</strong>. <br>
                                          <br>
                                          Login here <a href="https://www.recruitinghub.com/recruiter/login" target="_blank">Agency Login</a></td>
                                      </tr>
                                      <tr>
                                        <td><p>&nbsp;</p></td>
                                      </tr>
