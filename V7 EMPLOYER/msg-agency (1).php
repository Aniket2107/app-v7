...
<div class="tab-content">   
 ...
 <div class="col-xs-12">
      ...
      ?>
      <form enctype="multipart/form-data" action="msg-agency.php" method="post">
       ...
       if(isset($_GET['rid']))
        ...
        $empcompname = $empcnsd["name"];
          ...
          echo ' <option data-company="'.$empcompname.'" data-candiate="High Priority Requirement" data-employername="'.$name.'" data-member="Job ID - '.$jobid.' - '.$row['jobtitle'].'" value="'.$row['recruiter'].'" selected >'.$row['jobtitle'].'</option>';
          else
  ...
  <script type="text/javascript">
   ...
   $(function () 
   {
    $('input#membersub').val(candiate+' - '+empcompany+' - '+membername);
   });
     $('#engage').select2();
   $('#recipid').select2();
