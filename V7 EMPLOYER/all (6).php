...
elseif(isset($_GET['jobowner']) && ($_GET['jobowner']!='')){
  ...
  $jobowner=$_GET['jobowner'];
    if($adminrights){
      $sql="SELECT a.jobtitle as jobtitle,a.jobid,d.email as recruiteremail,e.name as agency,e.registerid, b.fname as candidatename,b.contactnumber,b.cv as cv,b.resume,c.status as candidatestatus,c.prestatus,c.viewnotes,c.comment,b.jobtype,b.desiredsalary,b.expectedcurrency,b.typesalary,c.submitdate,d.onlinestatus as onlinestatus,d.lastlogin as lastlogin,c.candidateid as candidateid, c.recruiterid as recruiterid , c.viewed,c.viewedtime,s.firstname as subuser,d.firstname as recsubuser,d.email as subuseremail FROM submitted_candidates c,jobs a,candidates b ,companyprofile e,members d ,members s  WHERE s.memberid ='$jobowner' and s.memberid = a.memberid and a.jobid=c.jobid and b.id=c.candidateid and c.recruiterid= d.memberid and d.companyid=e.id and submitdate >= CURDATE()-INTERVAL 6 MONTH order by submitdate desc";
...
$candidate=$_GET['candidate'];
if($adminrights){
  $sql="SELECT a.jobtitle as jobtitle,a.jobid,d.email as recruiteremail,e.name as agency,e.registerid, b.fname as candidatename,b.contactnumber,b.cv as cv,b.resume,c.status as candidatestatus,c.prestatus,c.viewnotes,c.comment,b.jobtype,b.desiredsalary,d.onlinestatus as onlinestatus,d.lastlogin as lastlogin,b.expectedcurrency,b.typesalary,c.submitdate,c.candidateid as candidateid, c.recruiterid as recruiterid , c.viewed,c.viewedtime,s.firstname as subuser,d.firstname as recsubuser,d.email as subuseremail FROM submitted_candidates c,jobs a,candidates b ,companyprofile e,members d ,members s  WHERE s.companyid ='$companyid' and s.memberid = a.memberid and a.jobid=c.jobid and b.id=c.candidateid and a.jobtitle like '%$jobtitle%' and ( b.resume like '%$candidate%' or c.candidateid='$candidate') and c.recruiterid= d.memberid and d.companyid=e.id  order by submitdate desc";
...
if($status=='CV Rejected')
	...
	$filter="c.status='$status'";
  if($adminrights){
    $sql="SELECT a.jobtitle as jobtitle,a.jobid,d.email as recruiteremail,e.name as agency,e.registerid, b.fname as candidatename,b.contactnumber,b.cv as cv,b.resume,c.status as candidatestatus,c.prestatus,c.viewnotes,c.comment,b.jobtype,b.desiredsalary,d.onlinestatus as onlinestatus,d.lastlogin as lastlogin,b.expectedcurrency,b.typesalary,c.submitdate,c.candidateid as candidateid, c.recruiterid as recruiterid,c.viewed,c.viewedtime,c.employernotes,c.recruiternotes,s.firstname as subuser,d.firstname as recsubuser,d.email as subuseremail FROM submitted_candidates c,jobs a,candidates b ,companyprofile e,members d ,members s  WHERE s.companyid ='$companyid' and s.memberid = a.memberid and a.jobid=c.jobid and b.id=c.candidateid and a.jobtitle like '%$jobtitle%'  and c.recruiterid= d.memberid and d.companyid=e.id  and $filter and submitdate >= CURDATE()-INTERVAL 6 MONTH order by submitdate desc";
...
$candidatemsg="<p style='
            font-size: 14px;
            color: #a02121;
        '>No candidates submitted in last 6 months found. May be our Recruitment Agencies are submitting candidates shortly. Try refreshing the job to gain more attention. Click here <a href='jobs'><b>Active Jobs</b></a> </p>";
?>
