...
if(isset($_GET['candidateid']) || isset($_POST['allcheck'])){
	...
	mysqli_query($link,"Update jobs INNER JOIN submitted_candidates ON submitted_candidates.jobid = jobs.jobid set submitted_candidates.status='Offered',submitted_candidates.feedbackdate=now() WHERE submitted_candidates.candidateid='$candidateid' and jobs.memberid='$mid'");
			...
			$q2=mysqli_query($link,"select e.email,e.offernotification,d.name,e.firstname from companyprofile d,members e ,submitted_benchcandidates c where  d.id=e.companyid  and e.memberid=c.recruiterid and c.candidateid='$candidateid'");
		while($row2 = mysqli_fetch_array($q2)){
			$array2=$row2;
				}
		$q1=mysqli_query($link,"select a.jobtitle,d.name from benchjobs a,companyprofile d,members e ,submitted_candidates c where  d.id=e.companyid  and e.memberid=a.memberid and c.jobid=a.jobid and c.candidateid='$candidateid'  ");
		...
		while($row3= mysqli_fetch_array($q3)){
            ...
            color: #21a021;
        "><strong>'.$array3['fname'].'</strong> has been offered. </p>';
		...
		<td style="padding:12px 12px 0px 12px"><table style="border-right:1px solid #d5d8d9;border-left:1px solid #d5d8d9" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td style="padding:0px 14px"><table border="0" cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td style="padding-top:5px;color:#313131"><table style="border-right:1px solid #d5d8d9;border-left:1px solid #d5d8d9" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="100%">
          <tbody>
            <tr>
              ...
              <td colspan="3" style="padding-right:12px"><div style="boder:0"><a href="https://www.recruitinghub.com/recruiter/login"><img src="https://www.recruitinghub.com/images/Offered.png" alt="www.recruitinghub.com"></a></div></td>
            </tr>
            <tr>
		...
		<td style="padding:12px 12px 0px 12px"><table style="border-right:1px solid #d5d8d9;border-left:1px solid #d5d8d9" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td style="padding:0px 14px"><table border="0" cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td style="padding-top:5px;color:#313131"><table style="border-right:1px solid #d5d8d9;border-left:1px solid #d5d8d9" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="100%">
          <tbody>
            <tr>
              ...
              <td colspan="3" style="padding-right:12px"><div style="boder:0"><a href="https://www.recruitinghub.com/"><img src="https://www.recruitinghub.com/images/Offered.png" alt="www.recruitinghub.com"></a></div></td>
            </tr>
            <tr>
              <td style="padding:0px 14px"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tbody>
...
'subject'=>$subject,'message'=>$message,'cc'=>$array2['email'],'cc2'=>'noreply@recruitinghub.com','send'=>true];
  ...
  echo "<script>
alert('Candidate has been Offered. An email notification has now been sent to the Recruiter & the Candidate');
</script>";
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          <div class="row">
            ...
            color: #21a021;
        '>Click here to Go to -> <a href="offer" id="four">OFFERED</a> folder</p>
    </div>
   </div>
  </div>
   </div>
