...
$jobalertnotification=$_POST['jobalertnotification'];
...
$sql=mysqli_query($link,"UPDATE members SET awnotification='$awaitingnotification',jobalertnotification='$jobalertnotification',requestnotification='$requestnotification',messagenotification='$messagenotification',reminders='$reminders',empreminder='$empreminder' where memberid='$mid'");
...
<div class="table-responsive">
     ...
     <form method="post" action="emanage-notification.php">
       <div class="form-group">
            ...
            <?php
			$sql1=mysqli_query($link,"SELECT awnotification,jobalertnotification,messagenotification,requestnotification,reminders,empreminder  FROM members WHERE memberid='$mid'"); 
      $members=mysqli_fetch_array($sql1);
		  ...
		  echo '</div> <div class="form-group"><p><strong>ENGAGEMENT REQUEST FROM AGENCIES NOTIFICATION</strong></p>';
        ...
        echo'</div><div class="form-group" > <p><strong>BENCH JOB ALERT NOTIFICATION </strong></p><input type="radio" name="jobalertnotification" value="1" checked>ON<br>
        <input type="radio" name="jobalertnotification" value="0">OFF </div>';
        }
        else{
        echo'<div class="form-group" > <p><strong>BENCH JOB ALERT NOTIFICATION </strong></p><input type="radio" name="jobalertnotification" value="1">ON<br>
        <input type="radio" name="jobalertnotification" value="0" checked>OFF </div>';
        } 
