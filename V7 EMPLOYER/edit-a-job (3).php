...
if(isset($_GET['jobid']) && isset($_GET['submit'])){
	$jobid=$_GET['jobid'];
	$action=$_GET['submit'];
...
$jobtitle=$row2["jobtitle"];
			...
			$subject = "RecruitingHub.com - $companyname has UPDATED the Job - $jobtitle";
                                      ...
                                      <tr>
                                        <td><p>
                                         Dear '.$row2['firstname'].',<br>
                                          ...
                                          <br>
                                          <b>'.$companyname.'</b> UPDATED the Job ID <b>('.$jobid.')</b> - <b>'.$jobtitle.'</b>.<br><br>
                                          
                                          This means the job details have been updated and you should now check by logging in to your Recruiter Account.<br><br>
...
$content="Updated changes successfully. Click here to go to Active Jobs section -> <a href=https://www.recruitinghub.com/employer/jobs><b>Active Jobs</b></a>";	
...
<div class="account-navi-content">
  ...
  <div class="row">
    ...
    <h3 class="panel-title"> You are Editing <b><?php echo $job['jobtitle']; ?></b> Job </h3>
  </header>
...
<?php 
$currencyarray=array('INR','AED','GBP','EURO','USD','SAR','QAR','OMR','BHD','KWD','CAD','AUD','JPY','MYR','SGD','IDR','CNY','KRW','RUB','NZD','HKD','THB','PHP','MAD','EGP','SEK','CHF','ZAR','ETB','PLN','BGN','HUF','VND','MXN','BRL'); 
?>
<?php 
...
<div class="form-group col-sm-12">
<label class="col-sm-4">  Agency Limit</label>
<div class="col-sm-8">
<select class="select required form-control form-control" required="required" aria-required="true" name="alimit">
...
<?php for($c=10000;$c<=100000;$c+=5000){ if($job['rfee']==$c) 
    echo'
