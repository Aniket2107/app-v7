...
if(isset($_GET['candidateid']) || isset($_POST['allcheck'])){
	...
	$recruiter='';
		...
		mysqli_query($link,"Update jobs INNER JOIN submitted_candidates ON submitted_candidates.jobid = jobs.jobid set jobs.status='Filled',jobs.filledvacancy=jobs.filledvacancy +1  WHERE submitted_candidates.candidateid='$candidateid' and jobs.memberid='$mid'");
			...
			$q2=mysqli_query($link,"select e.email,e.fillnotification,d.name,e.firstname from companyprofile d,members e ,submitted_benchcandidates c where  d.id=e.companyid  and e.memberid=c.recruiterid and c.candidateid='$candidateid'");
		while($row2 = mysqli_fetch_array($q2)){
			$array2=$row2;
				}
		$q1=mysqli_query($link,"select a.jobtitle,d.name,e.email,e.firstname from benchjobs a,companyprofile d,members e ,submitted_benchcandidates c where  d.id=e.companyid  and e.memberid=a.memberid and c.jobid=a.jobid and c.candidateid='$candidateid'  ");
	...
	$content="<p style = 'font-size: 16px;
            color: #21a021;
        '> Vacancy is now filled with <strong>".$array3['fname']."</strong></p>";
		...
		<td style="padding:12px 12px 0px 12px"><table style="border-right:1px solid #d5d8d9;border-left:1px solid #d5d8d9" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td style="padding:0px 14px"><table border="0" cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td style="padding-top:5px;color:#313131"><table style="border-right:1px solid #d5d8d9;border-left:1px solid #d5d8d9" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="100%">
          <tbody>
            <tr>
              ...
              <td colspan="3" style="padding-right:12px"><div style="boder:0"><a href="https://www.recruitinghub.com/recruiter/login"><img src="https://www.recruitinghub.com/images/Filled.png" alt="www.recruitinghub.com"></a></div></td>
            </tr>
            <tr>
		...
		<td style="padding:12px 12px 0px 12px"><table style="border-right:1px solid #d5d8d9;border-left:1px solid #d5d8d9" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td style="padding:0px 14px"><table border="0" cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td style="padding-top:5px;color:#313131"><table style="border-right:1px solid #d5d8d9;border-left:1px solid #d5d8d9" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="100%">
          <tbody>
            <tr>
              ...
              <td colspan="3" style="padding-right:12px"><div style="boder:0"><a href="https://www.recruitinghub.com/employer/login"><img src="https://www.recruitinghub.com/images/Filled.png" alt="www.recruitinghub.com"></a></div></td>
            </tr>
            <tr>
              <td style="padding:0px 14px"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tbody>
                            ...
                            <td><table border="0" cellspacing="0" cellpadding="0" width="100%">
                                <tr>
                                  <td valign="top"><table border="0" cellspacing="0" cellpadding="0" width="100%">
                                      <tr>
                                        <td><p>
                                         Dear '.$array1['firstname'].',<br>
                                          <br>
                                          Greetings from <a href="https://www.recruitinghub.com/employer/login" target="_blank">www.recruitinghub.com </a><br>
                                          <br>
                                      ...
                                      <tr>
                                        <td><p>Best Regards,<br>
                                            <a href="https://www.recruitinghub.com/employer/login" target="_blank">www.recruitinghub.com </a> </p></td>
                                      </tr>
                                  </table></td>
                                  <td width="20"><p>&nbsp;</p></td>
                                </tr>
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          <div class="row">
            ...
            color: #21a021;
        '> Click here to Go to -> <a href="filled" id="four">FILLED</a> folder to update <b>DOJ</b> & <b>Offer Amount</b> so we can send you the INVOICE</p>
    </div>
   </div>
  </div>
   </div>
