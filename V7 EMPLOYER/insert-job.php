...
$content="<h4><p style = 'font-size: 16px;
            color: #21a021;
        '>You have successfully posted your job to our recruiters marketplace! Our AI mechanism will trigger your job to our approved network of specialist recruitment agencies from within your sector and location that can find you quality candidates in hours. Post more jobs by clicking here <a href=https://www.recruitinghub.com/employer/submit-a-job><b>Post More Jobs</b></p></a> </h4>";
		$to = $email;
...
<table style="border-right:1px solid #d5d8d9;border-left:1px solid #d5d8d9;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#000" align="center" bgcolor="#792785" border="0" cellpadding="0" cellspacing="0" width="620">
    	...
    	<table style="border-right:1px solid #d5d8d9;border-left:1px solid #d5d8d9" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="100%">
      	<tbody>
	  		<tr>	
            	...
            	<td colspan="3" style="padding-right:12px"><div style="boder:0"><a href="https://www.recruitinghub.com/recruiter/login"><img src="https://www.recruitinghub.com/images/New Job.png" alt="www.recruitinghub.com"></a></div></td>
          </tr>
	  <tr>
        <td style="padding:0px 14px"><table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tbody><tr>
 ...
 <tr>
	 ...
	 $to = $row["email"];
    $subject = 'Recruiting Hub - New Job Alert - '.$jobtitle.' - '.$jobtype.' role in '.$joblocation.'';
	$from = "noreply@recruitinghub.com";
    $headers = "From: $from\r\n";
	$headers .= "Content-type: text/html\r\n";
