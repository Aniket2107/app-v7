...
<div class="account-navi-content">
  ...
  <p class="pricing-title">Success Fee Based</p><br>
   <p class="pricing-rate"> Post a Job to our Recruiters Marketplace Now <span></span> <span class="exclides-vat"></span> </p>
...
<a class="subs-button" href="submit-a-job""> Post your Job Now </a>
</form>
 </div>
...
<li><i class="fa fa-fw fa-files-o"></i>Pay per Placement on Success only</li>
    ...
    <li><i class="fa fa-clock-o"></i>Pay in 30 days from DOJ unless otherwise agreed </li>
      ...
      <br>
      <li><a class="subs-button" href="submit-a-job""> Post your Job Now </a></li>
    </ul>
  </form>
 </div>
...
<li><i class="fa fa-list"></i>Choose a Recruiter-On-Demand fixed fee plan</li>
 ...
 <div class="table-pricing">
  <div class="col-md-4 col-sm-12 col-xs-12">
  <div class="pricing-header ">
  <p class="pricing-title">Bench Hiring (C2C)</p><br>
   <p class="pricing-rate"> Post a Bench Job to our IT Vendors Now <span></span> <span class="exclides-vat"></span> </p>
  <p class="description"></p>
...
<a class="subs-button" href="post-benchjob""> Post Bench Job Now </a>
</form>
 </div>
<div class="pricing-list ">
    <ul>
    <li><i class="fa fa-check"></i>Hire an IT resource from our IT Vendors for your short term projects</li>
<li><i class="fa fa-fw fa-files-o"></i>Post your Bench Jobs</li>
    <li><i class="fa fa-check"></i>Receive Bench Resources submitted by our IT Vendors  </li>
    <li><i class="fa fa-clock-o"></i>Select your best resource from submissions made by our IT Vendors </li>
      <li><i class="fa fa-money"></i>Give Recruiting Hub the SOW for the resource you selected. You pay the end rate to Recruiting Hub monthly on time sheet approval basis for the resource we agreed in the SOW and we pay the IT Vendor who in turn pay the candidate.</li>
      <li><i class="fa fa-users"></i>Bench Resources are the Employees of our IT Vendors</li>
      <br>
      <li><a class="subs-button" href="post-benchjob""> Post Bench Job Now </a></li>
    </ul>
  </form>
 </div>
