...
if(isset($_GET['jobid'])){
	...
	$request= mysqli_fetch_assoc(mysqli_query($link,"select status from jobs where jobid='$jobid'"));
	$status=$request['status'];
	if($status=='Closed'){
			mysqli_query($link,"delete from jobs where jobid='$jobid'"); 
...
<div class="account-navi">
 ...
 <li><a href="resources" role="tab" > <i class="fa fa-database"></i>Rec-to-Rec</a> </li>
  </ul>
