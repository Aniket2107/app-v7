...
$sql=mysqli_query($link,"select * from citybycountry where country='US'");
...
<head>
    ...
    <title>Rec-Rec US | Employers Hub</title>
...
<div class="account-navi-content">
    ...
    <h3 class="text-center"> <b>Hire a Recruiter in the US</b> - Fixed Fee Plans  <a href="rec-rec-india">Or Click here to Hire a Recruiter in India</a>  <a href="rec-rec">Or Click here to Hire a Recruiter in the UK</a>  </h3>
  </header>
  ...
  <p class="pricing-title">Hire a Junior Recruiter @</p>
   <p class="pricing-rate"> $ 2500  <span>Monthly</span> <span class="exclides-vat">+ 20% VAT </span> </p>
  <p class="description">For Startups likely to fill 3 roles a month</p>
...
<a class="subs-button" href="https://pay.gocardless.com/AL00160EMPBYBQ" target="_blank"> Pay Now </a>
  </form>
 </div>
 <div class="pricing-list ">
    <ul>
<li><i class="fa fa-user"></i>Qualified US Junior Recruiter (1-3 years exp)</li>
<li><i class="fa fa-users"></i>Over 400 US Recruiters registered with us. We will assign you the best Recruiter </li>
    ...
    <li><i class="fa fa-money"></i>Save over $10k in Placement fees Monthly</li>
      <li><i class="fa fa-male"></i>Recruiter Starts in 3 days working remotely</li>
      <li><i class="fa fa-gbp"></i>You pay us and we pay the recruiter</li>
      ...
      <li><i class="fa fa-gbp"></i><a href="https://pay.gocardless.com/AL00160EMPBYBQ" target="_blank"> <b>Pay Now</b> </a></li>
      <li><i class="fa fa-gbp"></i><a href="https://www.recruitinghub.com/bankdetails" target="_blank">Or Click here to pay into our bank account directly </a></li>
    </ul>
  </div>
</div>
<div class="col-md-4 col-sm-12 col-xs-12">
  ...
  <p class="pricing-rate"> $ 4500  <span>Monthly</span> <span class="exclides-vat">+ 20% VAT </span> </p>
  <p class="description">For Mid size Companies looking to fill over 6 roles a month</p>
...
<a class="subs-button" href="https://pay.gocardless.com/AL00160ENSS81Y" target="_blank"> Pay Now </a>
 
  </form>
 </div>
 <div class="pricing-list ">
    <ul>
<li><i class="fa fa-user"></i>Qualified US Senior Recruiter (3-8 years exp)</li>
<li><i class="fa fa-users"></i>Over 400 US Recruiters registered with us. We will assign you the best Recruiter </li>
<li><i class="fa fa-linkedin"></i>Recruiter will have Linkedin Recruiter lite</li>
<li><i class="fa fa-search"></i>You will need to provide job board access. </li>
<li><i class="fa fa-money"></i>Save over $25k in Placement fees Monthly</li>
      <li><i class="fa fa-male"></i>Recruiter Starts in 3 days working remotely</li>
      <li><i class="fa fa-gbp"></i>You pay us and we pay the recruiter</li>
       <li><i class="fa fa-male"></i>Onsite based commutation expenses paid extra by you directly to recruiter</li>
    <li><i class="fa fa-stop"></i>Monthly rolling contract unless cancelled with 2 weeks notice</li>
    <li><i class="fa fa-gbp"></i><a href="https://pay.gocardless.com/AL00160ENSS81Y" target="_blank"> <b>Pay Now</b> </a></li>
      <li><i class="fa fa-gbp"></i><a href="https://www.recruitinghub.com/bankdetails" target="_blank">Click here to pay into our bank account directly </a></li>
    </ul>
  </div>
</div>
<div class="col-md-4 col-sm-12 col-xs-12">
