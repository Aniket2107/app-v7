...
if($job){
?>
<div id="job_title" data-value="<b><?php echo $job['jobtitle'];?></b> | Job Id: <b><?php echo $job['jobid'];?></b> | 1st Posted: <?php echo date("j F, Y",strtotime($job['postdate']));  ?> | Last Updated: <b><?php echo date("j F, Y",strtotime($job['updatedate']));  ?></b>"> </div>
