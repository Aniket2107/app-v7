...
<head>
    ...
    <title>Rec-Rec UK | Employers Hub</title>
...
<div class="account-navi-content">
    ...
    <h3 class="text-center"> <b>Hire a Recruiter in the UK</b> - Fixed Fee Plans  <a href="rec-rec-india">Or Click here to Hire a Recruiter in India</a>  <a href="rec-rec-us">Or Click here to Hire a Recruiter in the US</a> </h3>
  </header>
...
<a class="subs-button" href="https://pay.gocardless.com/AL00160ENW3R0C" target="_blank"> Pay Now </a>
  </form>
 </div>
 <div class="pricing-list ">
    <ul>
<li><i class="fa fa-user"></i>Qualified UK Junior Recruiter (1-3 years exp)</li>
<li><i class="fa fa-users"></i>Over 400 UK Recruiters registered with us. We will assign you the best Recruiter </li>
    ...
    <li><i class="fa fa-money"></i>Save over £10k in Placement fees Monthly</li>
      ...
      <li><i class="fa fa-gbp"></i><a href="https://pay.gocardless.com/AL00160ENW3R0C" target="_blank"> <b>Pay Now</b> </a></li>
...
<a class="subs-button" href="https://pay.gocardless.com/BRT0001E49E6QPW" target="_blank"> Pay Now </a>
 
  </form>
 </div>
 <div class="pricing-list ">
    <ul>
<li><i class="fa fa-user"></i>Qualified UK Senior Recruiter (3-8 years exp)</li>
<li><i class="fa fa-users"></i>Over 400 UK Recruiters registered with us. We will assign you the best Recruiter </li>
<li><i class="fa fa-linkedin"></i>Recruiter will have Linkedin Recruiter lite</li>
<li><i class="fa fa-search"></i>You will need to provide job board access. </li>
<li><i class="fa fa-money"></i>Save over £25k in Placement fees Monthly</li>
      ...
      <li><i class="fa fa-gbp"></i>You pay us and we pay the recruiter</li>
       <li><i class="fa fa-male"></i>Onsite based commutation expenses paid extra by you directly to recruiter</li>
    <li><i class="fa fa-stop"></i>Monthly rolling contract unless cancelled with 2 weeks notice</li>
    <li><i class="fa fa-gbp"></i><a href="https://pay.gocardless.com/BRT0001E49E6QPW" target="_blank"> <b>Pay Now</b> </a></li>
