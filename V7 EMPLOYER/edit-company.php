...
<div class="col-sm-10">
<input class="form-control" required placeholder="type address line1 for billing purposes" name="address1" value="<?php echo $address1; ?>"  type="text">
</div></div>
...
<!--<div class="form-group col-sm-12">
                                  ...
                                  <div class="col-sm-10">
                                    <div class="input-group">
                                        <select class="form-control form-select" name="industrytype" id="industrytype" required="" data-msg="Please select your industry.">
...
<div class="form-group col-sm-12">
<label class="col-sm-2">Company Tax info</label>
<div class="col-sm-10">
<input class="form-control" required name="taxinfo" placeholder="e.g VAT No or GST No or type NA if not applicable" value="<?php echo $profile['taxinfo']; ?>" type="text">
</div></div>
