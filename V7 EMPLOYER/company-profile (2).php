...
<a class="btn btn-primary" href="https://www.recruitinghub.com/bankdetails" target=_blank> RH Bank Details </a>   
	...
	<div class="panel panel-default">
      <header class="panel-heading wht-bg ui-sortable-handle">
        <h3 class="panel-title"> Company Profile | Company ID - <?php echo $company['id']; ?> <a class="btn btn-primary" href="edit-company">
      ...
      <div class="panel-body">
              <div class="row results-table-filter">
                <div class="col-md-12">               
                  ...
                  <div class="col-md-12">    
                  <textarea rows="10" cols="480" class="form-control" readonly><?php echo  $companyprofile; ?></textarea></p>
...
<div class="panel panel-default widget-mini" id="account_statistic">
  <header class="panel-heading wht-bg ui-sortable-handle">
    <h3 class="panel-title"> Personal Details  <a class="btn btn-primary" href="edit-profile"> <i class="fa fa-pencil"></i> Edit your Personal Profile </a></h3>
  </header>
  <div class="panel-body">
