...
$candidatemsg="<p style='
            font-size: 14px;
            color: #a02121;
        '>No shortlisted candidates yet. Submit Candidates to Engaged Jobs. <a href='add_new'><b>Submit New Candidate</b></a>";
?>
<!doctype html>
<html>
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     <title>Bench Shortlisted | Employers Hub</title>
