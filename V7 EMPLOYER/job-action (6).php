...
if(isset($_GET['jobid']) && isset($_GET['a'])){
	...
	if($action=='close'){
		...
		$content="<p style = 'font-size: 16px;
            color: #a02121;
        '>You have closed the job. Click here to go to Active Jobs section -> <a href=https://www.recruitinghub.com/employer/jobs><b>Active Jobs</b></a> or Closed Jobs section -> <a href=https://www.recruitinghub.com/employer/closed><b>Closed Jobs</b></a></p>";
			$request=mysqli_query($link,"select * from request where jobid='$jobid'");
		...
		<td style="padding:12px 12px 0px 12px"><table style="border-right:1px solid #d5d8d9;border-left:1px solid #d5d8d9" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td style="padding:0px 14px"><table border="0" cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td style="padding-top:5px;color:#313131"><table style="border-right:1px solid #d5d8d9;border-left:1px solid #d5d8d9" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="100%">
          <tbody>
            <tr>
              ...
              <td colspan="3" style="padding-right:12px"><div style="boder:0"><a href="https://www.recruitinghub.com/recruiter/login"><img src="https://www.recruitinghub.com/images/Closed.png" alt="www.recruitinghub.com"></a></div></td>
            </tr>
            <tr>
                                      ...
                                      <tr>
                                        <td><p>
                                         Dear '.$row2['firstname'].',<br>
                                          <br>
                                          Greetings from <a href="https://www.recruitinghub.com/recruiter/login" target="_blank">www.recruitinghub.com </a><br>
                                          <br>
...
'subject'=>$subject,'message'=>$message,'cc'=>$r['email'],'cc2'=>'noreply@recruitinghub.com','send'=>true];
  AsyncMail($params);
	...
	elseif($action=='inactive'){
		...
		$content="<p style = 'font-size: 16px;
            color: #a02121;
        '>You have put the job on temp hold. Click here to go to Active Jobs -> <a href=https://www.recruitinghub.com/employer/jobs><b>Active Jobs</b></a> or Inactive Jobs -> <a href=https://www.recruitinghub.com/employer/inactive><b>Inactive Jobs</b></a></p>";
		$request=mysqli_query($link,"select * from request where jobid='$jobid'");
		...
		<td style="padding:12px 12px 0px 12px"><table style="border-right:1px solid #d5d8d9;border-left:1px solid #d5d8d9" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td style="padding:0px 14px"><table border="0" cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td style="padding-top:5px;color:#313131"><table style="border-right:1px solid #d5d8d9;border-left:1px solid #d5d8d9" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="100%">
          <tbody>
            <tr>
              ...
              <td colspan="3" style="padding-right:12px"><div style="boder:0"><a href="https://www.recruitinghub.com/recruiter/login"><img src="https://www.recruitinghub.com/images/Hold.png" alt="www.recruitinghub.com"></a></div></td>
            </tr>
            <tr>
              <td style="padding:0px 14px"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tbody>
                                      ...
                                      <tr>
                                        <td><p>
                                         Dear '.$row2['firstname'].',<br>
                                          ...
                                          <p style = "font-size: 14px;
            color: #a02121;"><b>PLEASE STOP WORKING ON THIS ROLE UNTIL FURTHER NOTICE.</b> This job has now been moved to DISENGAGED/CLOSED folder which can be found in your Recruiter login. We will notify you when the job reopens so you can continue to submit candidates.</p>
                                          Login here <a href="https://www.recruitinghub.com/recruiter/login" target="_blank">Recruiter Login</a></td>
                                      </tr>
...
'subject'=>$subject,'message'=>$message,'cc'=>$r['email'],'cc2'=>'noreply@recruitinghub.com','send'=>true];
  AsyncMail($params);
	...
	elseif($action=='filled'){
		...
		$content="<p style = 'font-size: 16px;
            color: #21a021;
        '>You have changed the job status as Filled. Click here to go to FILLED Jobs -> <a href=https://www.recruitinghub.com/employer/filled><b>FILLED Jobs</b></a></p>";
		}
	elseif($action=='reopen'){
        mysqli_query($link,"update jobs set status='Open',priority=1,updatedby='$mid',updatedate=now() WHERE jobid='$jobid' ");  
        $content="<p style = 'font-size: 16px;
            color: #21a021;
        '>You have changed the job status to Open. Click here to go to FILLED Jobs -> <a href=https://www.recruitinghub.com/employer/jobs><b>OPEN Jobs</b></a></p>";
        $request=mysqli_query($link,"select * from request where jobid='$jobid'");
		...
		<td style="padding:12px 12px 0px 12px"><table style="border-right:1px solid #d5d8d9;border-left:1px solid #d5d8d9" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td style="padding:0px 14px"><table border="0" cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td style="padding-top:5px;color:#313131"><table style="border-right:1px solid #d5d8d9;border-left:1px solid #d5d8d9" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="100%">
          <tbody>
            <tr>
              ...
              <td colspan="3" style="padding-right:12px"><div style="boder:0"><a href="https://www.recruitinghub.com/recruiter/login"><img src="https://www.recruitinghub.com/images/Reopened.png" alt="www.recruitinghub.com"></a></div></td>
            </tr>
            <tr>
              <td style="padding:0px 14px"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tbody>
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     <title>Job Action | Employers Hub</title>
